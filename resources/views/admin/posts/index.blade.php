                ...
                <div class="col-md-8">
                    <form>
                        ...
                        <div>
                            <div id="slo">
                                <h4>Slo</h4>
                                <input type="text" name="name" placeholder="Naslov novice (slo)" class="box mb15">
                                <textarea class="box mb15" placeholder="vsebina (slo)"></textarea>
                            </div>
                            <div id="eng" style="display: none">
                                <h4>Eng</h4>
                                <input type="text" name="name" placeholder="Naslov novice (eng)" class="box mb15">
                                <textarea class="box mb15" placeholder="vsebina (eng)"></textarea>
                            </div>
                            <div id="ger" style="display: none">
                                <h4>Ger</h4>
                                <input type="text" name="name" placeholder="Naslov novice (ger)" class="box mb15">
                                <textarea class="box mb15" placeholder="vsebina (ger)"></textarea>
                            </div>
                        </div>
