...
<div>
    <div id="slo">
        <h4>Slo</h4>
        {!! Form::textarea('excerpt[sl]', null, ['class' => 'box mb15 content', 'placeholder' => 'Kratek opis (slo)']) !!}
    </div>
    <div id="eng" style="display: none">
        <h4>Eng</h4>
        {!! Form::textarea('excerpt[en]', null, ['class' => 'box mb15 content', 'placeholder' => 'Kratek opis (eng)']) !!}
    </div>
    <div id="ger" style="display: none">
        <h4>Ger</h4>
        {!! Form::textarea('excerpt[de]', null, ['class' => 'box mb15 content', 'placeholder' => 'Kratek opis (ger)']) !!}
    </div>
</div>
